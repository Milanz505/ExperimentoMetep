...
# Converte a lista de transações em um formato adequado para o FP-Growth
...
for value in SuporteMinimo:
    #executa 10 vezes o FP-Growth
    for i in range(10):
        TempoInicial = timer()
        frequent_itemsets = fpgrowth(df, min_support=value)
        TempoFinal= timer()
...
plt.title('Tempo médio de execução do FP-Growth em relação ao suporte mínimo')
